...
type GateOptions struct {
	...
	CodecMsgCreator             codec.IMsgCreator            // 消息包解码器的消息构建器
...
func (WithOption) Default() GateOption {
	return func(options *GateOptions) {
		...
		WithOption{}.CodecMsgCreator(codec.DefaultMsgCreator())(options)
...
func (WithOption) CodecMsgCreator(mc codec.IMsgCreator) GateOption {
	return func(options *GateOptions) {
		if mc == nil {
			panic("option CodecMsgCreator can't be assigned to nil")
		}
		options.CodecMsgCreator = mc
	}
}
