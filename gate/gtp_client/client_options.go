...
func (Option) EncCipherSuite(cs transport.CipherSuite) ClientOption {
	return func(options *ClientOptions) {
		options.EncCipherSuite = cs
	}
}

func (Option) EncSignatureAlgorithm(sa transport.SignatureAlgorithm) ClientOption {
	return func(options *ClientOptions) {
...
func (Option) Compression(c transport.Compression) ClientOption {
	return func(options *ClientOptions) {
