...
func (c *ComponentBehavior) RPC(service, comp, method string, args ...any) runtime.AsyncRet {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).RPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) BalanceRPC(service, comp, method string, args ...any) runtime.AsyncRet {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).BalanceRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) GlobalBalanceRPC(comp, method string, args ...any) runtime.AsyncRet {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).GlobalBalanceRPC(comp, method, args...)
}

// OneWayRPC 向分布式实体目标服务发送单向RPC
func (c *ComponentBehavior) OneWayRPC(service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).OneWayRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) BalanceOneWayRPC(service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).BalanceOneWayRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) GlobalBalanceOneWayRPC(comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).GlobalBroadcastOneWayRPC(comp, method, args...)
}
...
func (c *ComponentBehavior) BroadcastOneWayRPC(service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).BroadcastOneWayRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) CliRPC(method string, args ...any) runtime.AsyncRet {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).CliRPC(method, args...)
}
...
func (c *ComponentBehavior) CliRPCToEntity(entityId uid.Id, method string, args ...any) runtime.AsyncRet {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).CliRPCToEntity(entityId, method, args...)
}

// OneWayCliRPC 向客户端发送单向RPC
func (c *ComponentBehavior) OneWayCliRPC(method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).OneWayCliRPC(method, args...)
}
...
func (c *ComponentBehavior) OneWayCliRPCToEntity(entityId uid.Id, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetService().Ctx, c.GetEntity().GetId()).OneWayCliRPCToEntity(entityId, method, args...)
}
