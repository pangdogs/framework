...
func (c *ComponentBehavior) RPC(service, comp, method string, args ...any) async.AsyncRet {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).RPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) BalanceRPC(service, comp, method string, args ...any) async.AsyncRet {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).BalanceRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) GlobalBalanceRPC(excludeSelf bool, comp, method string, args ...any) async.AsyncRet {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).GlobalBalanceRPC(excludeSelf, comp, method, args...)
}

// OneWayRPC 向分布式实体目标服务发送单向RPC
func (c *ComponentBehavior) OneWayRPC(service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).OneWayRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) BalanceOneWayRPC(service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).BalanceOneWayRPC(service, comp, method, args...)
}
...
func (c *ComponentBehavior) GlobalBalanceOneWayRPC(excludeSelf bool, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).GlobalBalanceOneWayRPC(excludeSelf, comp, method, args...)
}
...
func (c *ComponentBehavior) BroadcastOneWayRPC(excludeSelf bool, service, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).BroadcastOneWayRPC(excludeSelf, service, comp, method, args...)
}
...
func (c *ComponentBehavior) GlobalBroadcastOneWayRPC(excludeSelf bool, comp, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).GlobalBroadcastOneWayRPC(excludeSelf, comp, method, args...)
}

// CliRPC 向客户端发送RPC
func (c *ComponentBehavior) CliRPC(method string, args ...any) async.AsyncRet {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).CliRPC(method, args...)
}

// CliRPCToEntity 向客户端实体发送RPC
func (c *ComponentBehavior) CliRPCToEntity(entityId uid.Id, method string, args ...any) async.AsyncRet {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).CliRPCToEntity(entityId, method, args...)
}

// OneWayCliRPC 向客户端发送单向RPC
func (c *ComponentBehavior) OneWayCliRPC(method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).OneWayCliRPC(method, args...)
}
...
func (c *ComponentBehavior) OneWayCliRPCToEntity(entityId uid.Id, method string, args ...any) error {
	return rpcutil.ProxyEntity(c.GetRuntime(), c.GetEntity().GetId()).OneWayCliRPCToEntity(entityId, method, args...)
}
