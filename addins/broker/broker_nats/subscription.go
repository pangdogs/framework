...
func (b *_Broker) addSubscriber(ctx context.Context, pattern string, handler broker.EventHandler, options broker.SubscribeOptions) (<-chan broker.Event, async.Future, error) {
	if ctx == nil {
