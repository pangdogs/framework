...
func Trace(provider extension.AddInProvider, v ...interface{}) {
...
func Traceln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(TraceLevel, v...)
}

// Tracef logs a formatted message at TraceLevel.
func Tracef(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Debug(provider extension.AddInProvider, v ...interface{}) {
...
func Debugln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(DebugLevel, v...)
}

// Debugf logs a formatted message at DebugLevel.
func Debugf(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Info(provider extension.AddInProvider, v ...interface{}) {
...
func Infoln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(InfoLevel, v...)
}

// Infof logs a formatted message at InfoLevel.
func Infof(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Warn(provider extension.AddInProvider, v ...interface{}) {
...
func Warnln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(WarnLevel, v...)
}

// Warnf logs a formatted message at WarnLevel.
func Warnf(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Error(provider extension.AddInProvider, v ...interface{}) {
...
func Errorln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(ErrorLevel, v...)
}

// Errorf logs a formatted message at ErrorLevel.
func Errorf(provider extension.AddInProvider, format string, v ...interface{}) {
...
func DPanic(provider extension.AddInProvider, v ...interface{}) {
...
func DPanicln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(DPanicLevel, v...)
}

// DPanicf logs a formatted message at DPanicLevel.
func DPanicf(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Panic(provider extension.AddInProvider, v ...interface{}) {
...
func Panicln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(PanicLevel, v...)
}

// Panicf logs a formatted message at PanicLevel.
func Panicf(provider extension.AddInProvider, format string, v ...interface{}) {
...
func Fatal(provider extension.AddInProvider, v ...interface{}) {
...
func Fatalln(provider extension.AddInProvider, v ...interface{}) {
	Using(provider).Logln(FatalLevel, v...)
}

// Fatalf logs a formatted message at FatalLevel.
func Fatalf(provider extension.AddInProvider, format string, v ...interface{}) {
